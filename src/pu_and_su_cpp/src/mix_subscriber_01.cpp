...
class TopicSubscribe01:public rclcpp::Node
{
    ...
    TopicSubscribe01(std::string name):Node(name)
    {
        ...
        command_subscribe_02 = this->create_subscription<std_msgs::msg::String>("/number",10,std::bind(&TopicSubscribe01::command_callback_02,this,std::placeholders::_1));
    }
    ...
    private:
        ...
        rclcpp::Subscription<std_msgs::msg::String>::SharedPtr command_subscribe_02;
        ...
        void command_callback_02(const std_msgs::msg::String::SharedPtr msg)
        {
            msg_2 =msg->data;
            has_msg_02 =true;
            mix_msg();
